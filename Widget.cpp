...

{
    ...
    this->setStyleSheet("QWidget{background-color:rgb(28,28,28);}");
    ...
    menuButton->setStyleSheet("QPushButton{image:url(:/play.png); border-radius:15px; border: none; background-color:rgb(28,28,28);}"
...
//    connect(menuButton2, &QPushButton::clicked, this, &Widget::slotMenuButton);
    ...
    menuButton2->setText("VideoPlayer");
    menuButton2->setStyleSheet("QPushButton{border:none; color:rgb(255,255,255); font-size:21px; font-family: Comic Sans MS; }");
    //connect(menuButton2, &QPushButton::clicked, this, &Widget::slotMenuButton);

    titleLabel = new QLabel(this);
    titleLabel->setGeometry(130,15,500,20);
    titleLabel->setStyleSheet("QLabel{color:rgb(232,232,232); background-color:rgb(28, 28, 28)}");
    ...
    menu->setStyleSheet(" QMenu{border:none } "
                        "QMenu::item{border:none; font-size:13px;  padding-left:20px; background-color:white; height:25px; width:50px; }"
                         "QMenu::item:selected{ background-color:rgb(105,105,105)}");
...
//    menuButton2->setMenu(menu);
    ...
    bottomWidget->setStyleSheet("QWidget{background-color:rgb(0,0,0)}");
    ...
    stopButton->setStyleSheet("QPushButton{image:url(:/stop.png); border-radius:20px; background-color: rgb(0,0,0)}"
    ...
    lastVideoButton->setStyleSheet("QPushButton{image:url(:/backward.png);border-radius:20px; background-color: rgb(0,0,00)}"
    ...
    playButton->setStyleSheet("QPushButton{image:url(:/play.png);  border-radius:25px; background-color: rgb(0,0,0)}"
    ...
    nextVideoButton->setStyleSheet("QPushButton{image:url(:/forward.png);border-radius:20px; background-color: rgb(0,0,0)}"
    ...
    volumeButton->setStyleSheet("QPushButton{image:url(:/volume.png);border-radius:15px; background-color: rgb(0,0,0)}"
...
void Widget::slotStateChanged(QMediaPlayer::State state)
{
    switch(state)
    {
        ...
        {
            playButton->setStyleSheet("QPushButton{image:url(:/pause.png);border-radius:25px; background-color: rgb(0,0,0)}"
...
//    qDebug()<<""<<recorder.videoCodecDescription("h.261");
    ...
    //QSize size = mediaPlayer0->currentMedia().resources().at(0).resolution();
